...
**Group:** `CompatPatcherWindow.cs`, `CompatCompareWindow.cs`, `UnityYaml.cs`, `ModReader.cs`, `ConflictAnalyzer.cs`, `PatchBuilder.cs`, `Sidecar.cs`, `LoadOrderValidator.cs` (all under `com.hk.modtools.compatpatcher`'s `Editor/CompatPatcher/`)
...
2. **CompatPatcher package (`com.hk.modtools.compatpatcher`):** `CompatPatcher/CompatPatcherWindow.cs`, `CompatPatcher/CompatCompareWindow.cs`, `CompatPatcher/UnityYaml.cs`, `CompatPatcher/ModReader.cs`, `CompatPatcher/ConflictAnalyzer.cs`, `CompatPatcher/PatchBuilder.cs`, `CompatPatcher/Sidecar.cs`, `CompatPatcher/LoadOrderValidator.cs`
